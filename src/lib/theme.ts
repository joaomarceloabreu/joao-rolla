...
export const theme = createTheme({
  ...
  shadows: [
    ...
    '0px 48px 96px rgba(0, 0, 0, 0.44)',
    '0px 56px 112px rgba(0, 0, 0, 0.48)',
    '0px 64px 128px rgba(0, 0, 0, 0.52)',
    '0px 72px 144px rgba(0, 0, 0, 0.56)',
    '0px 80px 160px rgba(0, 0, 0, 0.60)',
    '0px 88px 176px rgba(0, 0, 0, 0.64)',
    '0px 96px 192px rgba(0, 0, 0, 0.68)',
    '0px 104px 208px rgba(0, 0, 0, 0.72)',
    '0px 112px 224px rgba(0, 0, 0, 0.76)',
    '0px 120px 240px rgba(0, 0, 0, 0.80)',
    '0px 128px 256px rgba(0, 0, 0, 0.84)',
    '0px 136px 272px rgba(0, 0, 0, 0.88)',
    '0px 144px 288px rgba(0, 0, 0, 0.92)',
    '0px 152px 304px rgba(0, 0, 0, 0.96)',
